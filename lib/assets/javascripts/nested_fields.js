function addNestedFields(element){
...
function removeNestedFields(element){
  const parent = findNestedFieldsParent(element)
...
function findNestedFieldsParent(element){
  ...
  return findNestedFieldsParent(parent)
}
